...
<body>
   ...
   <div id="wb_Form1" style="position:absolute;left:0px;top:15px;width:356px;height:282px;z-index:13;">
      <form name="Form1" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" id="Form1">
         ...
         <div id="wb_Text1" style="position:absolute;left:0px;top:13px;width:356px;height:25px;text-align:center;z-index:2;">
            <span style="color:#3C2415;font-family:Lato;font-size:21px;">ЗАКАЗАТЬ ЗВОНОК</span></div>
         <div id="wb_Shape3" style="position:absolute;left:189px;top:148px;width:140px;height:50px;z-index:3;">
            <a href="./1.php"><img src="images/img0001.png" id="Shape3" alt="" style="width:140px;height:50px;"></a></div>
         <div id="wb_Shape2" style="position:absolute;left:31px;top:148px;width:140px;height:50px;z-index:4;">
            <a href="javascript:history.back()" onclick="ShowObject('wb_Text3', 1);ShowObject('wb_Text4', 0);ShowObject('Layer2', 1);return false;"><img src="images/img0002.png" id="Shape2" alt="" style="width:140px;height:50px;"></a></div>
         ...
         <div id="Layer2" style="position:absolute;text-align:left;left:14px;top:142px;width:330px;height:68px;z-index:8;">
            <div id="wb_Shape1" style="position:absolute;left:18px;top:3px;width:297px;height:56px;z-index:0;">
               <a href="#" onclick="ShowObject('Layer2', 0);ShowObject('wb_Text4', 1);ShowObject('wb_Text3', 0);return false;"><img src="images/img0003.png" id="Shape1" alt="" style="width:297px;height:56px;"></a></div>
         </div>
